...
- Detects the known `9999 FPS / 0.1 ms` startup artifact and lets the user exclude it non-destructively
...
The FrameTime file contains individual frame durations. Version 1.1 uses those raw frames for:
